        ...
        for to_email in to_email_list:
            ...
            try:
                if file_shared_type == 'f':
                    ...
                    send_html_email(_(u'A file is shared to you on %s') % config.SITE_NAME,
                    ...
                    send_html_email(_(u'A directory is shared to you on %s') % config.SITE_NAME,
                                    'shared_link_email.html',
                                    c, from_email, [to_email],
                                    reply_to=reply_to)
...
def send_shared_upload_link(request):
    ...
    if form.is_valid():
        ...
        for to_email in to_email_list:
            ...
            try:
                send_html_email(_(u'An upload link is shared to you on %s') % config.SITE_NAME,
